...
public class calculationfour extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculationfour);
...
//                    Vi=(pow((1+r),m)-1)/(pow((1+r),(m-1))*m*r);
            ...
            Toast.makeText(calculationfour.this, "Error: Check all the values that are entered.", Toast.LENGTH_LONG).show();
        }
    }
